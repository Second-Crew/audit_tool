...
- Google's [Search Essentials](https://developers.google.com/search/docs/essentials) support crawlable links, clear titles/headings, and helpful content. [Search Console](https://developers.google.com/search/docs/monitor-debug/search-console-start) supplies actual query, page, index, and performance evidence; on-site checks alone cannot replace it. Google's current [AI-features guide](https://developers.google.com/search/docs/appearance/ai-features) includes AI-feature clicks and impressions in the Web performance report, so that aggregate report alone does not isolate AI citations or answer appearances.
