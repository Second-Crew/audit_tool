...
A read-only review of Second Crew's Search Console performance report provided a first-party SEO baseline; no private export or query table was committed. Exact-query Google research on the same signed-in California browser is being kept distinct from that site-owner evidence. Two controlled queries used `hl=en`, `gl=us`, `pws=0`, and a Sunnyvale location context. Ads and local business packs preceded the web results in both sessions. The first four web results for [San Jose ecommerce agency](https://www.google.com/search?q=web+design+agency+san+jose+ca+ecommerce&hl=en&gl=us&pws=0&num=20) were Jives Media, a Web Tonic Shopify-agency article, Baunfire, and a Built In SF directory article. The first four for [San Francisco ecommerce agency](https://www.google.com/search?q=web+design+agency+san+francisco+ca+ecommerce&hl=en&gl=us&pws=0&num=20) were a RevenueBase directory, Thrive Internet Marketing Agency, a Lazarev agency comparison article, and Enormac Digital. Second Crew was not among the visible first-page organic links in either session. These are session-specific positions; publisher and directory results are separate from agency-site results, and neither ads nor local packs were counted as organic.
