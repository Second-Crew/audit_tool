...
function buildIndustryInsight(audit) {
  ...
  if (audit.primary.signals.contentEvidence?.status === 'incomplete') return `For ${target}, the returned HTML did not provide enough content for a reliable on-site assessment. Browser rendering and a repeat audit are needed before business recommendations.`;
