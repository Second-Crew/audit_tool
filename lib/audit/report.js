  ...
  <main class="wrap">
    ...
    <section class="section">
      ...
      <div class="cols">
        ...
        <div class="card">
          ...
          <ul>
            ${audit.competitorComparison.length ? audit.competitorComparison.map((competitor) => `<li>${escapeHtml(competitor.domain)}: ${competitor.scores.aeoGeo}/100 GEO/AEO, ${competitor.crawledPages} pages crawled</li>`).join('') : '<li>No manual competitors submitted</li>'}
          </ul>
        </div>
      </div>
    </section>
    ...
    <section class="section">
      ...
      <table>
        ...
        <tbody>
          ${audit.competitorComparison.map((competitor) => `
            <tr>
