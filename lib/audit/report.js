...
<body>
  <main class="wrap">
    ...
    ${primary.signals.contentEvidence?.status === 'sufficient' && scores.overall == null ? '<section class="card"><strong>Overall outcome grade withheld</strong><p>On-site checks are reviewable below. Search ranking and AI citation outcomes were not measured, so an overall grade would imply unsupported precision.</p></section>' : ''}
    <section class="grid">
    ...
    <section class="card">
      ...
      <p class="muted">This report records sampled on-site evidence. A fixed query panel and observed search or AI results are needed to assess visibility.</p>
    </section>
