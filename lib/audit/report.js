...
<body>
  <main class="wrap">
    ...
    ${primary.signals.contentEvidence?.status === 'incomplete' ? `<section class="card"><strong>Content assessment unavailable</strong><p>Only ${primary.signals.contentEvidence.usablePages} of ${primary.signals.contentEvidence.pages} sampled pages had enough extractable text. Render the pages and repeat the audit before using content recommendations or an overall grade.</p></section>` : ''}
    <section class="grid">
