...
<body>
  <main class="wrap">
    ...
    ${primary.signals.contentEvidence?.status === 'sufficient' && scores.overall == null ? '<section class="card"><strong>N/A means not measured, not zero</strong><p>On-site checks are reviewable below. Search ranking and AI citation outcomes were not measured, and no validated scale connects the sampled checks to an AI-readiness grade. Overall and GEO/AEO grades are withheld until outcome evidence supports them.</p></section>' : ''}
    <section class="grid">
