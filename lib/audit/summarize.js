...
export function summarizeAuditForResponse(audit) {
  return {
    ...
    input: audit.input,
    semantic: audit.semantic || null,
    assessment: audit.assessment || null,
    primary: {
      siteType: audit.primary.signals.siteType,
      contentEvidence: audit.primary.signals.contentEvidence,
...
function summarizePageForResponse(page) {
  return {
    ...
    evidenceSource: page.evidenceSource || 'fetched_html',
