...
export function buildMarkdownReport(data) {
  ...
  if (contentEvidence?.status === 'incomplete') lines.push(`- **Content assessment:** Unavailable; ${contentEvidence.usablePages}/${contentEvidence.pages} sampled pages had extractable text. Review incomplete pages and reassess before content recommendations.`);
